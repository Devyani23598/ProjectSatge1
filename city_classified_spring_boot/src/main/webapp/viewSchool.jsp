...
<%List<BusinessListing> businesslisting =(List<BusinessListing>) request.getAttribute("businesslist"); %>

<body class="container">
<form action="schooldetails" class="w-50 m-auto" method="post">
<h2 class="text-center pt-4 mt-4">Hospitals</h2>
<input type="hidden" name="requestAction" value="schooldetails" />
